...
function Search() {
    ...
    const goToSidebar = useCallback(() => {
        setFocus('NAV-SEARCH'); // Or whatever your sidebar focus key is
    }, []);
            ...
            <div ref={pageRef} className="search-page">
                ...
                {hasQuery && (
                    <div className="search-page__section">
                        ...
                        <LandscapeResultRow onMoveLeft={goToSidebar} onCollapseKeyboard={handleCollapseKeyboard}
                                            onScrollToTop={scrollToTop}/>
                    </div>
                )}
